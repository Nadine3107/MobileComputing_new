    ...
    <>
      <ScrollView style={[{ paddingBottom: 20 }]}>
        ...
        <View style={{ marginBottom: 10 }}>
          <Text>Nachbarschaftsapp</Text>
          <Text>Musterstrasse 1, Muster, Hausnummer 1,</Text>
        ...
        <View style={{ marginBottom: 10 }}>
          ...
          <Text>Registergericht: Musterstadt</Text>
        </View>
        <View style={{ marginBottom: 20 }}>
          <Text>Tel.: 01234/56789</Text>
          <Text>Fax: 01234/56789-0</Text>
          <Text>E-Mail: hallo@musterfirma.de</Text>
        </View>
        <View style={{ marginBottom: 10 }}>
          <Text style={{ fontWeight: "bold" }}>Aufsichtsbehörde</Text>
          <Text>Bezirkshauptmannschaft Musterstadt</Text>
          <Text>Webseite der Aufsichtsbehörde</Text>
          <Text>https://www.aufsichtsbeoerde-musterstadt.de/</Text>
          <Text>Anschrift der Aufsichtsbehörde</Text>
          <Text>Musterweg 1, 12345 Musterstadt</Text>
        </View>
        <View style={{ marginBottom: 10 }}>
          <Text style={{ fontWeight: "bold" }}>
            Persönlich haftende Gesellschafter (Komplementär) der GmbH 
          </Text>
          <Text>Musterfrau</Text>
        </View>
        <View style={{ marginBottom: 10 }}>
          <Text style={{ fontWeight: "bold" }}>Geschäftsführer</Text>
          <Text>Melina Classen, Nadine Krautscheid</Text>
        </View>
        <View style={{ marginBottom: 10 }}>
          <Text style={{ fontWeight: "bold" }}>
